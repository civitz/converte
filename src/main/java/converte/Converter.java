...
public class Converter {
	...
	public static Runnable convert(Consumer<Double> onProgressPercent,FfmpegParameters ffmpegParams, ConversionParameters params, SourceFile sourceFile, Path outputFile) throws IOException {
